...
describe('FeedbackManager', () => {
  it('should create and update debris', () => {
    ...
    manager.update(1.1);
    expect((manager as any).debris.length).toBe(0);
  });
  ...
  it('should create and update ripples', () => {
    ...
    manager.update(1.1);
    expect((manager as any).ripples.length).toBe(0);
  });
  ...
  it('should create and update trails', () => {
    ...
    manager.update(1.1);
    expect((manager as any).trails.length).toBe(0);
  });
  ...
  it('should create and update shockwaves', () => {
    ...
    manager.update(1.1);
    expect((manager as any).shockwaves.length).toBe(0);
  });
  ...
  it('should create and update lasers', () => {
    ...
    manager.update(3.1);
    expect((manager as any).lasers.length).toBe(0);
  });
  ...
  it('should update vignette', () => {
    ...
    manager.update(1.1);
    expect((manager as any).vignette.graphic).toBe(null);
  });
  ...
  it('should update starfield', () => {
    ...
    expect((manager as any).starfield.children[0].tint).not.toBe(0xffffff);
  });
});
