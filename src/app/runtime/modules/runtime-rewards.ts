...
export interface RuntimeRewardsOptions {
    ...
    readonly onRenderStageSoon: () => void;
    readonly onRequestHudRefresh: () => void;
    readonly onHudPulseCombo: (intensity: number) => void;
    readonly onFlashPaddleLight: (intensity: number) => void;
    readonly onClearExtraBalls: () => void;
    readonly onReattachBallToPaddle: () => void;
    readonly onResetAutoCompleteCountdown: () => void;
}
...
export const createRuntimeRewards = ({
    ...
    const rewardWheel = createRewardWheelOrchestrator({
        ...
        setRewardOverride,
        refreshHud: onRequestHudRefresh,
        renderStageSoon: onRenderStageSoon,
        eventBus,
        createReward,
    });
